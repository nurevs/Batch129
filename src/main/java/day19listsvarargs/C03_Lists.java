 ...
 */
        ...
        c.add("2");
        c.add("9");
        System.out.println("c = " + c);//c = [5, 8, 2, 9]
        String sayi ="";
        int counter=0;

        do {
            System.out.println("Lutfen 1-10 arasi bir sayi tahmin ediniz ve veriniz");
            sayi= input.next().substring(0,1);  //input.next().charAt(0);kullanmadik cunku String urun
