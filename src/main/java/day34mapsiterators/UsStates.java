...
public enum UsStates {
    /*
    i)Data deposudur.
    ii)Sabit , degisme ihtimali olmayan datalari koyar
    Mesela haftanin gunleri,yilin aylari..
    iii)Sabit datalari , application icine gommek icin "enum" kullanilir.
    iv)Cunku application'lar kendi basina ayakta  duruyor (standalone) olabilmelidir.
    ...
    private final String stateName;//state isimleri degistirilemez , o yuzden final yaptik
