...
public class HashMap01 {
    ...
    2)"USA= 400,000,000" data'sinin "USA" kismi "key" olarak adlandirilir. Key'ler unique'dir
    3)"USA= 400,000,000" data'sinin "400,000,000" kismi "value" olarak adlandirilir. ve "value"ler "tekarli" olabilir
    4)Map'lerde depoladigimiz her bir dataya "Entry" denir. Eleman denmez.
    5)Entry'ler unique'dir. cunku key kisimlari unique oldugundan herbir "Entry" birbirinden farklidir.
    6)HashMap cok hislidir  cunku HashMapler siralama ile ugrasmazlar.
    7) "HashMap" lerde bir tane "key" i "null" yapabilirsiniz.
    8)"HashMap"lerde birden fazla tane "value" u "null" yapabilirsiniz.
    9)"HashMap"ler "mutli thread" icin kullanilamaz ve "synchronization" yoktur.
        i)multi thread: Ayni anda birden fazla is yapabilmez becerisi.
