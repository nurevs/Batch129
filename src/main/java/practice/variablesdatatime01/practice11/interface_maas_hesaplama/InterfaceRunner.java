package practice.variablesdatatime01.practice11.interface_maas_hesaplama;
...
/*
    ...
    Maaş kriterleri: Çalışanın toplam çalışma yılına göre her yıl için brüt maaşı 100 dolar  artır.
                     ...
                     10 yıl ve üstü çalışma yılı bulunan çalışanların brut maaşlarından %30, diğerlerinden %20 vergi kesintisi yap.
     */
    public static void main(String[] args) {


    MaasHesapla maasHesaplaAli=new MaasHesapla();
        System.out.println(maasHesaplaAli.netMaas(10000, 11, 160));
        ...
        System.out.println(maasHesaplaAyse.netMaas(10000, 15, 170));
