...
public class TextOkumaYazma {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileReader fr=new FileReader("src/main/java/practice/variablesdatatime01/practice11/HelloWorld");
    ...
    FileWriter writer=new FileWriter("src/main/java/practice/variablesdatatime01/practice11/HelloWorld");
